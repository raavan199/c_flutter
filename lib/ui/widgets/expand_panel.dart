...
///
/// The position of the panel within an [ExpandPanelList] is given by
/// [panelIndex].
...
/// [ExpandPanelList].
///
/// See [ExpandPanelList] for a sample implementation.
///
/// See also:
///
///  * [ExpandPanelList]
...
class ExpandPanel {
  /// Creates an expansion panel to be used as a child for [ExpandPanelList].
  /// See [ExpandPanelList] for an example on how to use this widget.
  ///
...
/// expansions.
///
/// Note that [expansionCallback] behaves differently for [ExpandPanelList]
...
///  * <https://material.io/design/components/lists.html#types>
class ExpandPanelList extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const ExpandPanelList({
    Key? key,
    this.children = const <ExpandPanel>[],
  ...
  /// fashion to [ListBody].
  final List<ExpandPanel> children;
  ...
  @override
  State<StatefulWidget> createState() => _ExpandPanelListState();
}

class _ExpandPanelListState extends State<ExpandPanelList> {
  ...
  @override
  void didUpdateWidget(ExpandPanelList oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    for (var index = 0; index < widget.children.length; index += 1) {
      ...
      final ExpandPanel child = widget.children[index];
